package com.example.recyclefragment.ui.recycler;
...
import com.example.recyclefragment.adapter.UserDetailAdapter;
import com.example.recyclefragment.model.UserDetail;
...
public class RecyclerFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (image == "Birat") {
            img = R.drawable.dybala;
        }
        if (image == "Model") {
            img = R.drawable.hazard;
        }
        if (image == "Old") {
            img = R.drawable.kroos;
        }
        if (image == "Four") {
            img = R.drawable.marcello;
        }
        if (image == "Five") {
            img = R.drawable.ronaldo;
        }
